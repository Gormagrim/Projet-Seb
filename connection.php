    ...
    <div class="row form-row connection">
        <div class="form-group offset-1 col-10 offset-sm-4 col-sm-4 offset-md-4 col-md-4 offset-lg-4 col-lg-4">
            <div class="formConnection">
                ...
                <input type="email" class="form-control" id="inputEmail4" placeholder="exemple@mail.com">
                <label for="inputPassword4">Mot de passe :</label>
                <input type="password" class="form-control" id="inputPassword4" placeholder="Mot de passe">
            </div>
        </div>
    </div>
    <button type="button" class="btn btn-outline-warning registrationBtn connectionBtn" onclick="javascript:location.href = 'particularUser.php'">Suivant</button>
</form>
