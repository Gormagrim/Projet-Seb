                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 firstCard">
                                    <div class="card mb-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h4 class="card-title">Entreprise Yalah</h4>
                                                    <h5 class="card-title">Exemple de réalisation</h5>
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body second">
                                                    <h4 class="card-title">Entreprise Ploufff</h4>
                                                    <h5 class="card-title">Exemple de réalisation</h5>
                                ...
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="card mb-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body second">
                                                    <h4 class="card-title">Entreprise Trep</h4>
                                                    <h5 class="card-title">Exemple de réalisation</h5>
