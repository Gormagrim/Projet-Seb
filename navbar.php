...
<html lang="fr" dir="ltr">
    ...
    <body>
        <nav class="navbar fixed-top navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <button type="button" class="btn btn-outline-warning hightBtn" onclick="javascript:location.href = 'connection.php'">Connexion</button>
                    </li>
                </ul>
            </div>
        </nav>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 topSite">
                    <p>Vos travaux et projets en toute simplicité.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 topSite">
