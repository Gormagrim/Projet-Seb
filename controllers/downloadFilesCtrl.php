        ...
        if (preg_match($regexId, $_SESSION['id'])) {
            ...
            if (count($_POST) > 0) {
                ...
                if (count($formErrors) == 0) {
                    ...
                    $production->id_al2jt_company = $getCompanyId->id;
                    if ($insertProduction = $production->inserProduction()) {
                        $photo->id_al2jt_production = $insertProduction;
                        $insertPhoto = $photo->inserPhoto();
